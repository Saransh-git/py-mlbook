...
plt.grid(True)
plt.title("Silhouette value chart")
plt.xlabel("Number of Clusters")
...
plt.grid(True)
plt.title("Total within cluster sum of squares chart")
plt.xlabel("Number of Clusters")
...
axs.set_title("Scatterplot for LATITUDE versus LONGITUDE")
plt.show()
